  ...
  ga.getAdjacentTile = function (index, dir) {
    ...
    switch (dir) {
      ...
      case 'dl':
        ...
        tileIndex = leftTile ? downTile - 1 : null;
        break;
      case 'dr':
    ...
    // const type = ga.world.tileTypes[ga.world.objects[54].data[tileIndex] - 1];
        ...
        tiledLayer.data.forEach(function(gid, index) {
          ...
          if (gid !== 0) {
            ...
            if (tileproperties[key] && tileproperties[key].name) {
              ...
              // This is a custom addition (offline o.e.c.t)
              // to support my own legacy code during rewrite.
              tileSprite.type = tileproperties[key].name;
